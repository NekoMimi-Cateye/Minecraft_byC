...
## 遊び方
### メニュー画面
- 「NEWGAME」をクリックでワールド新規作成画面へ
- 「COUNTINUE」をクリックでつづきから (読み込むワールドがない場合はエラーがこちらで作成したエラー文が返されて終了します)
- 「QUIT」をクリックでゲーム終了
### ワールド新規作成
...
- 上部中央の3個の欄 ... 左上が素材, 左下が燃料, 右が完成後のアイテム
    ...
    + クラフト画面とは異なり, いったん閉じても情報は保存されており, その間も燃料がある限りは裏で製錬を行うが, セーブはされないため終了前にはかまど内にものが残っていないか確認する必要がある.
## メニュー画面
- 「Continue the Game」をクリックでゲーム画面に戻る.
- 「Save the Game」をクリックでセーブ. セーブはちゃんとすること.
- 「Back to Title」をクリックでゲームを終えてタイトルに戻る.
## 満腹と空腹
